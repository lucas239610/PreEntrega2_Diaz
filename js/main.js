var MiNombre=prompt("Escriba su nombre");
        ...
        var MisDias=parseInt(prompt("Escriba la cantidad de dias que trabaja en el mes"))
        ...
        (MiAntiguedad < 3 && MiAntiguedad >= 0)? ValorAntiguedad = 80000 : (MiAntiguedad >= 3 && MiAntiguedad < 5)? ValorAntiguedad = 110000 :(MiAntiguedad>= 5)? ValorAntiguedad = 150000 : (alert("El valor es invalido por favor ingresar la cantidad de años en numero"),console.error("El valor no corresponde"))
        ...
        var SueldoTotal= (ValorAntiguedad + BonoPresentismo )
